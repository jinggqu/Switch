...
from zoo.Projector import Projector
...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        self.proj = Projector(in_channels=self.n_class, out_channels=16)
...
class UNet(nn.Module):
    ...
    def forward(self, x, proj=False):
        ...
        out, feat = self.decoder(feats)

        return (out, feat) if proj else out
