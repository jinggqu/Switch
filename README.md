# Multi-scale Switch for Semi-Supervised and Contrastive Learning in Medical Ultrasound Image Segmentation
...
- 🔀 **Multi-Scale Switch (MSS)**: Hierarchical patch mixing (128×128 coarse + 32×32 fine) between labeled and unlabeled images for uniform spatial coverage.
...
**Stage 1 - MSS**: The student network learns from mixed labeled/unlabeled samples generated by multi-scale patch masks, supervised by ground truth and teacher pseudo-labels.
